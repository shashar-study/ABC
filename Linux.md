...
![image-20200811140740909](C:\Users\shasha\AppData\Roaming\Typora\typora-user-images\image-20200811140740909.png)

开关机的指令我没有自己运行，因为本地没有装虚拟机，也不想关闭自己的服务器
...
<img src="C:\Users\shasha\AppData\Roaming\Typora\typora-user-images\image-20200811141305568.png" alt="image-20200811141305568" style="zoom:200%;" />
...
这里，我新建了一个vimtest.txt文件如下：

<img src="C:\Users\shasha\AppData\Roaming\Typora\typora-user-images\image-20200811163915503.png" alt="image-20200811163915503" style="zoom: 67%;" />

敲击回车键，vim启动，进入命令模式如下：

<img src="C:\Users\shasha\AppData\Roaming\Typora\typora-user-images\image-20200811164014917.png" alt="image-20200811164014917" style="zoom:33%;" />
...
<img src="C:\Users\shasha\AppData\Roaming\Typora\typora-user-images\image-20200811164055131.png" alt="image-20200811164055131" style="zoom:50%;" />

输入模式，底部显示insert

- **x** 删除当前光标所在处的字符（在命令模式使用）。
- **:** 切换到底线命令模式，以在最底一行输入命令（在命令模式下使用）。

想要从输入模式切换到底线命令模式，需要先ESC退出，返回命令模式，然后用：，进入底线命令模式
...
![img](https://mmbiz.qpic.cn/mmbiz_png/uJDAUKrGC7L1I72C1HrwJ9bG6XAbVggM4461hqusRbQZ32967zqUhChqXbCzJTN3I20RpiaVbFqWvHicvicc9icBUQ/640?wx_fmt=png&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1)
...
![img](https://mmbiz.qpic.cn/mmbiz_png/uJDAUKrGC7L1I72C1HrwJ9bG6XAbVggMEarICtkr8ia1N6zqcuv3ROj1TBDoMicM5DoYzaGU29qQ2mbQhlBUbbww/640?wx_fmt=png&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1)

**按下 ESC 按钮回到一般模式**

好了，假设我已经按照上面的样式给他编辑完毕了，那么应该要如何退出呢？是的！没错！就是给他按下 **Esc** 这个按钮即可！马上你就会发现画面左下角的 – INSERT – 不见了！

在一般模式中按下 **:wq** 储存后离开 vim！，w是保存，q是退出
